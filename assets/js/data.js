...
const PROFILE = {
  ...
  tagline:
    "I build the pipelines, models and retrieval systems that turn messy data into decisions people actually act on.",
  summary:
    "MS in Data Science from University at Buffalo. Currently at ASM International building LLM-powered search and enrichment pipelines over 500K+ scientific documents.",
  ...
  /* Hero metric strip — animated counters */
  metrics: [
    { value: 500, suffix: "K+", label: "Documents indexed", detail: "Scientific corpus at ASM International" },
    { value: 93.5, suffix: "%", label: "Best model accuracy", detail: "Fine-tuned DeBERTa-v3 on 50K+ samples", decimals: 1 },
    { value: 60, suffix: "%", label: "Manual effort removed", detail: "GitLab CI/CD automation" },
    { value: 3.5, suffix: "M+", label: "Records processed", detail: "NYC taxi pipeline on AWS Glue + Athena", decimals: 1 },
  ],
  ...
  about: {
    ...
    highlights: [
      { icon: "sparkles", value: "RAG & LLM", label: "Production retrieval pipelines" },
      { icon: "database", value: "ETL at scale", label: "Python · SQL · AWS · Airflow-style DAGs" },
      { icon: "chart", value: "Experimentation", label: "A/B testing, MLflow, cohort analysis" },
      { icon: "users", value: "Stakeholder-facing", label: "Worked with CEOs and cross-functional teams" },
    ],
  },

  /* Infinite marquee */
  stack: [
    "Python", "SQL", "PyTorch", "Hugging Face", "scikit-learn", "MLflow",
    "AWS", "Databricks", "Snowflake", "PySpark", "Docker", "GitLab CI",
    "OpenSearch", "FastAPI", "Streamlit", "Power BI", "Tableau", "MongoDB",
  ],
  ...
  experience: [
    {
      ...
      blurb:
        "Building the data and LLM infrastructure behind AI-powered search across a half-million scientific documents.",
      points: [
      ...
      tags: ["RAG", "LLM", "OpenSearch", "NLP", "GitLab CI/CD", "Python"],
      accent: "primary",
    },
    {
      company: "Youro LLC",
      ...
      location: "Buffalo, NY",
      blurb:
        "Healthcare data platform work — ETL, statistical analysis, and business intelligence reporting straight to the founder.",
      points: [
      ...
      tags: ["ETL", "SQL", "Healthcare", "Business Intelligence", "Python"],
      accent: "cyan",
    },
    {
      company: "NoZanZat",
      ...
      location: "Pune, India",
      blurb:
        "Demand analytics and churn modelling for an operations-heavy consumer business.",
      points: [
      ...
      tags: ["Churn Modelling", "Power BI", "scikit-learn", "SQL"],
      accent: "violet",
    },
  ],
  ...
  projects: [
    {
      ...
      category: "Analytics",
      summary:
        "End-to-end subscription analytics: MRR, churn, LTV and cohort retention across 10,000+ subscribers, plus a statistically-validated A/B testing program.",
      points: [
      ...
      stats: [
        { k: "10K+", v: "Subscribers" },
        { k: "60%", v: "Churn traced to 3 segments" },
        { k: "+25%", v: "Experiment success rate" },
      ],
      tags: ["SQL", "Tableau", "A/B Testing", "Cohort Analysis", "Excel"],
    ...
    },
    {
      ...
      category: "NLP",
      summary:
        "A controlled benchmark of 5 LLM and ML approaches on 50K+ text samples, with full MLflow experiment tracking and a fine-tuned transformer winner.",
      points: [
      ...
      stats: [
        { k: "93.5%", v: "Accuracy" },
        { k: "50K+", v: "Text samples" },
        { k: "30+", v: "Tracked runs" },
      ],
      tags: ["PyTorch", "Hugging Face", "DeBERTa-v3", "MLflow", "NLP"],
      link: "https://github.com/siddhyaaddy/sentiment-wars",
      accent: "violet",
      featured: true,
    },
    {
      ...
      summary:
        "Time-series demand forecasting over 3.5M+ NYC taxi trips, served through a Streamlit dashboard on an AWS-native pipeline.",
      points: [
      ...
      stats: [
        { k: "3.5M+", v: "Trips/day" },
        { k: "-40%", v: "ETL time" },
        { k: "-25%", v: "Query latency" },
      ],
      tags: ["AWS Glue", "Athena", "RDS", "Streamlit", "Time Series"],
    ...
    },
    {
      ...
      summary:
        "Full end-to-end ML pipeline on NYC Yellow Taxi data (2023–2024): ingestion, feature store, LightGBM models and a live prediction dashboard.",
      points: [
      ...
      stats: [
        { k: "2.3M", v: "Data points" },
        { k: "LightGBM", v: "Best model" },
        { k: "Hourly", v: "Forecast horizon" },
      ],
      tags: ["Python", "LightGBM", "AWS", "Streamlit", "Feature Store"],
    ...
    },
    {
      ...
      summary:
        "AR-powered virtual fitting room using pose estimation and garment segmentation. Work published as a research paper.",
      points: [
      ...
      stats: [
        { k: "Published", v: "Research paper" },
        { k: "Real-time", v: "Pose tracking" },
        { k: "AR", v: "Delivery" },
      ],
      tags: ["Computer Vision", "Pose Estimation", "Segmentation", "AR"],
  ...
  skillGroups: [
    ...
    },
    {
      ...
      icon: "database",
      accent: "rose",
      items: ["Hadoop", "PySpark", "Databricks", "Snowflake", "MongoDB", "NoSQL"],
    },
    {
      name: "Tooling & Delivery",
      icon: "tools",
      accent: "primary",
      items: ["Git", "Jupyter", "Streamlit", "FastAPI", "Excel", "MATLAB"],
    },
  ],

  /* Radar chart — self-assessed depth, 0-100 */
  radar: [
    { axis: "ML / DL", value: 88 },
    { axis: "NLP & LLMs", value: 92 },
    { axis: "Data Engineering", value: 85 },
    { axis: "Statistics", value: 80 },
    { axis: "Visualization", value: 78 },
    { axis: "Cloud / MLOps", value: 82 },
  ],
  ...
  education: [
    ...
    },
    {
      ...
      school:
        "Savitribai Phule Pune University — Dr. D.Y. Patil Institute of Engineering, Management and Research",
  ...
  certifications: [
    { name: "IBM Data Science Professional Certificate", issuer: "IBM", year: "Ongoing", icon: "brain", accent: "primary" },
    { name: "Data Analytics Professional Certificate", issuer: "Google", year: "2023", icon: "chart", accent: "amber" },
    { name: "Real-Time Inference & Streaming Concepts", issuer: "Self-directed", year: "2025", icon: "bolt", accent: "cyan" },
    { name: "Mathematical Optimization Models", issuer: "Coursework", year: "2024", icon: "sigma", accent: "violet" },
  ],
};
